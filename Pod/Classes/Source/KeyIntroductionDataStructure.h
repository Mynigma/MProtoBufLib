...
@interface KeyIntroductionDataStructure : VersionDataStructure
...
@property NSString* theOldKeyLabel;
@property NSString* theNewKeyLabel;
@property NSData* theNewEncKey;
@property NSData* theNewVerKey;
@property NSDate* dateSigned;
