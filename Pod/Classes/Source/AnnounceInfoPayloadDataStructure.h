...
@interface AnnounceInfoPayloadDataStructure : VersionDataStructure
...
@property NSData* publicKeyVerData;
@property NSData* publicKeyEncData;
@property NSString* keyLabel;
@property NSData* hashData;
@property NSData* deviceDiscoveryPayloadData;
